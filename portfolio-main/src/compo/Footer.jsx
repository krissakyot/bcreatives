...
const Footer = () => {
  return (
    <footer className="bg-[#013220]" id="contact">
        <div className="flex flex-col md:flex-row md:items-center">
        <div className="md:order-2 text-[#fff] text-center text-[1.5rem] px-[1rem]">
            <p className="md:text-[2rem]">Do you have any project ideas in mind?</p>
            <p className="md:text-[2rem]">Let’s discuss it!</p>
        </div>
        <img src={cont} alt="" className="md:order-1" />
        </div>
        <div className="bg-[#fff] flex flex-col items-center px-[1rem] md:flex-row md:justify-between md:p-[.5rem]">
